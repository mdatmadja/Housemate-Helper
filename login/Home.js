          ...
          <div className='navbar-container'>
            ...
            <div ref={navbarLinks} className='navbar-links menu-collapse'>
                ...
                <li className='nav-item'>
                  <NavLink activeClassName='is-active' exact={true} className='nav-link' to='/'>Home1</NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink activeClassName='is-active' exact={true} className='nav-link' to='/joingroup'>Join a group</NavLink>
                </li>
                <li className='nav-item'>
...
function Home1() {
  return (
    <h1>Welcome to Housemate Helper!</h1>
  );
}
